...
dm_datasets <- arcgislayers::arc_read(
...
stopifnot(all(!duplicated(dm_datasets$dataset_code)))
# mapView(dm_datasets, zcol = "dataset_code")
# dm_datasets
# A tibble: 14 × 5
...
usethis::use_data(dm_datasets, overwrite = TRUE)
